...
namespace Animancer.Editor
{
    ...
    public static partial class AnimancerEditorUtilities
    {
        ...
        {
            return TempContent(property.displayName, property.tooltip);
        }

        /************************************************************************************************************************/

        /// <summary>Gets a <see cref="GUILayout"/> rect occupying a single standard line.</summary>
        public static Rect GetLayoutRect(bool useStandardVerticalSpacing = false)
        {
        ...
        /// <summary><see cref="GUIStyle"/>s used by Animancer.</summary>

...
namespace Animancer
{
    ...
    public sealed class ClipState : AnimancerState, IEarlyUpdate
    {
        ...
        /// <see cref="AnimancerNode.OnStartFade"/>, and <see cref="AnimancerState.Stop"/>.
        /// </summary>
        /// <remarks>
        ...
        void IEarlyUpdate.EarlyUpdate(out bool needsMoreUpdates)
        {
            if (IsPlaying && _OnEnd != null)
            {
                ...
                else
                {
                    ...
                    // But it's safer to continue doing it every frame while over the limit in case you only register a
                    // callback after the animation has ended but are still relying on it getting called.

                    // If you want it to only get called once, you can just unregister it during the call.
        ...
        public sealed class Drawer : Editor.AnimancerStateDrawer<ClipState>
        {
            ...
            private void DoAnimationTypeWarningGUI(IAnimancerComponent owner)
            {
                ...
                if (_AnimationTypeWarning != "")
                {
                    ...
                    if (Editor.AnimancerEditorUtilities.TryUseClickEventInLastRect())
            ...
            {
                if (_HasEndEvent && Target._OnEnd == null && Target.TargetWeight != 0)
                {
                    UnityEditor.EditorGUILayout.HelpBox("This animation has an event called 'End'" +
                        " but no 'OnEnd' delegate is currently registered for this state. Click here for more info.",
        ...
        public class Serializable : Serializable<ClipState>
        {
            ...
            [Tooltip("The time to start the animation at if the toggle is enabled")]
            [SerializeField]
            ...
            /// <see cref="AnimancerPlayable.CrossFadeFromStart(AnimancerState, float)"/>.
            /// </summary>
            ...
            public class Drawer : Editor.AnimancerStateSerializableDrawer
            {
                    ...
                    UnityEditor.SerializedProperty baseProperty, UnityEditor.SerializedProperty property, GUIContent label)
                {
                    if (property.propertyPath.EndsWith("._StartTime"))
                    {
                        ...
                        var normalizedArea = Editor.AnimancerEditorUtilities.StealFromRight(ref timeArea, _NormalizedWidth);
                        ...
                        label.text = Editor.AnimancerEditorUtilities.GetNarrowText("Start Time");

...
namespace Animancer
{
    ...
    /// </summary>
    public sealed class AnimancerPlayable : PlayableBehaviour,
        IEnumerable<AnimancerState>, IEnumerator, IDisposable, IPlayableWrapper, IAnimationClipSource
    {
        /************************************************************************************************************************/
        ...
        /// <summary>
        /// Returns true as long as the <see cref="PlayableGraph"/> hasn't been destroyed (such as by <see cref="Dispose()"/>).
        /// </summary>
...
#if UNITY_EDITOR
                description.AppendLine(editor.Target.Name);
#endif
        ...
        /// <para></para>
        /// If the layer currently has 0 <see cref="AnimancerNode.Weight"/>, this method will instead start fading in the layer
        /// itself and simply <see cref="AnimancerState.Play"/> the 'state'.
        /// <para></para>
        ...
        /// <para></para>
        /// If the 'state' isn't currently at 0 <see cref="AnimancerNode.Weight"/>, this method will actually fade it
        ...
        /// <para></para>
        /// If the animation isn't currently at 0 <see cref="AnimancerNode.Weight"/>, this method will actually fade
        ...
        public bool IsPlaying()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                if (_Layers[i].IsAnyStatePlaying())
                    return true;
            }
        ...
        /// <summary>[Warning]
        /// You should not use an <see cref="AnimancerState"/> as a key.
        /// Just call <see cref="AnimancerState.Dispose"/>.
        /// </summary>
        ...
        /// <summary>[Warning]
        /// You should not use an <see cref="AnimancerState"/> as a key.
        /// Just check <see cref="AnimancerNode.IsPlaying"/>.
        /// </summary>
        ...
        /// <summary>[Internal]
        /// Called by Unity before the <see cref="PlayableGraph"/> is evaluated. Updates the playing states.
        /// </summary>
        ...
        internal void DoUpdateListGUI()
        {
            ...
            if (Editor.AnimancerEditorUtilities.TryUseClickEventInLastRect(1))
            {

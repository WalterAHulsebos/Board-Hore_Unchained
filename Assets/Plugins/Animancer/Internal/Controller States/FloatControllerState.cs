...
namespace Animancer
{
    ...
    public sealed class FloatControllerState : ControllerState
    {
        ...
        /// <summary>
        /// Constructs a new <see cref="FloatControllerState"/> to play the 'controller' and connects it to the
        /// the 'layer'.
        /// </summary>
        ...
        public new class Serializable : Serializable<FloatControllerState>
        {
            ...
            /// <summary>Constructs a new <see cref="Serializable"/> with the specified Animator Controller and parameter.</summary>
            public Serializable(RuntimeAnimatorController controller, string parameterName)
            {
            ...
            {
                return State = new FloatControllerState(layer, Controller, _ParameterName, KeepStateOnStop);
            }

...
namespace Animancer
{
    ...
    public sealed class Vector2ControllerState : ControllerState
    {
        ...
        /// <summary>
        /// Constructs a new <see cref="Vector2ControllerState"/> to play the 'controller' and connects it to the
        /// the 'layer'.
        /// </summary>
        ...
        public new class Serializable : Serializable<Vector2ControllerState>
        {
            ...
            /// <summary>Constructs a new <see cref="Serializable"/> with the specified Animator Controller and parameters.</summary>
            public Serializable(RuntimeAnimatorController controller, string parameterNameX, string parameterNameY)
            {
            ...
            {
                return State = new Vector2ControllerState(layer, Controller, _ParameterNameX, _ParameterNameY, KeepStateOnStop);
            }
            ...
            public class Drawer : ControllerState.Serializable.Drawer
            {
                ...
                /// <see cref="ControllerState.Serializable.Drawer.Parameters"/>.
                /// </summary>

...
namespace Animancer
{
    ...
    public sealed class Vector3ControllerState : ControllerState
    {
        ...
        /// <summary>
        /// Constructs a new <see cref="Vector3ControllerState"/> to play the 'controller' and connects it to the
        /// the 'layer'.
        /// </summary>
        ...
        public new class Serializable : Serializable<Vector3ControllerState>
        {
            ...
            {
                return State = new Vector3ControllerState(layer, Controller,

...
namespace Animancer
{
    ...
    public sealed class AnimancerLayer : AnimancerNode, IAnimationClipSource
    {
        ...
        /// <summary>Returns the <see cref="AnimancerNode.PortIndex"/>.</summary>
        public static implicit operator int(AnimancerLayer layer)
        {
        ...
        /// <see cref="AnimancerState.HasLength"/>.</exception>
        ...
        /// <para></para>
        /// If this layer currently has 0 <see cref="AnimancerNode.Weight"/>, this method will instead start fading in the layer
        ...
        /// </summary>
        public static int maxCrossFadeFromStartDepth = 5;
#endif
        ...
        /// <summary>
        /// Sets <see cref="AnimancerNode.Weight"/> = 0 and calls <see cref="AnimancerState.Stop"/> on all animations to stop them

...
namespace Animancer
{
    ...
    public abstract class AnimancerState : AnimancerNode, IDisposable, IAnimationClipSource
    {
        ...
        public int LayerIndex
        {
            ...
            set
            {
                if (_Parent != null && _Parent.Layer.PortIndex == value)
                    return;
        ...
        /// <summary>
        /// The number of seconds the animation will take to play fully at its current <see cref="AnimancerNode.Speed"/>.
        /// <para></para>
        ...
        /// }
        /// </code>
        /// Note that we aren't passing an <see cref="AnimationClip"/> into <c>PlayAnimation</c> like the previous
        /// examples. Usually you would already have a serialized field for the <see cref="AnimationClip"/> so you
        /// would simply replace it with a <see cref="ClipState.Serializable"/>.
        /// </example>
        ///
        /// <remarks>
        ...
        /// Sets <see cref="AnimancerNode.IsPlaying"/> = true, <see cref="AnimancerNode.Weight"/> = 1, and
        /// <see cref="OnEnd"/> = null.
        /// <para></para>
        ...
        /// Sets <see cref="AnimancerNode.IsPlaying"/> = false, <see cref="Time"/> = 0,
        /// <see cref="AnimancerNode.Weight"/> = 0, and <see cref="OnEnd"/> = null.
        /// <para></para>
        /// If you only want to freeze the animation in place, you can set <see cref="AnimancerNode.IsPlaying"/> =
        /// false instead. Or to freeze all animations, you can call <see cref="AnimancerPlayable.PauseGraph"/>.
        /// </summary>

    ...
    SubShader
    {
		...
		Pass
		{
            ...
            fixed4 frag(v2f i) : SV_Target{
                ...
                for(int j = 0; j < _SampleCount; ++j){
                    ...
                    if(depth_delta < _BIAS) ao += 1.0f * _Intensity; 
                }
        ...
        Pass{
            ...
            fixed4 frag (v2f i) : SV_Target{
                 ...
                 fixed4 avg = (col + col1 + col2 + col3 + col4) / 5.0;
                 float f = abs(col.x - avg.x);
                 return (1 - f) * avg + (f) * col;
        ...
        Pass{
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float f = (hemisphericalVisibility.x - 0.5f);
                f *= f*f;
                
                
                return 0.5f * col + (0.75f + f) * 0.5f;
            }
            ENDCG
        }        
    }

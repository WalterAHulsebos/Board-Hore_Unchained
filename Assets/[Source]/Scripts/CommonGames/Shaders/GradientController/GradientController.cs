...
namespace Dynamic_Static
{
        ...
        : MonoBehaviour
    {
        ...
        [InlineEditor]
        [SerializeField] private GradientHandle 
            handle0,
            handle1;
        ...
        [SerializeField, HideInInspector] private bool materialApplied = false;
        ...
        private void OnDrawGizmos()
        {
            if (drawGizmo)
            {
                ...
                for (int i = 0; i < Count; ++i)
                {
                    ...
                    Gizmos.DrawWireCube(Vector3.zero, Vector3.one * gizmoSize * 0.85f);
                    handle.transform.localScale = Vector3.one * gizmoSize;

...
{
    //Most of the Extension Methods in these GeometryExtensions are based on the MIT licensed Daniil Basmanov library:
    ...
    public static partial class Math
    {
        ...
        public static Vector2 GetAngleBisector(Vector2 previous, Vector2 current, Vector2 next, out float degrees)
        {
            ...
            UnityEngine.Assertions.Assert.IsFalse(float.IsNaN(degrees));
